...
defmodule BeamPM.Types.Manifest do
  ...
  def fields(:agent_capability_advertisement), do: [:agent_subject_sha, :capability_digest, :valid_until]
  ...
  def fields(:bounded_work_selection_receipt), do: [:receipt_id, :selected_work_item_id, :frontier_digest]
  ...
  def fields(:distributed_work_queue_observation), do: [:consumer_subject_sha, :queue_digest, :observed_at]
  ...
  def fields(:next_event_prediction_contract), do: [:prediction_id, :prefix_digest, :distribution_digest]
  ...
  def fields(:nondeterministic_effect_contract), do: [:action_id, :effect_set_digest, :selection_semantics]
  ...
  def fields(:planning_blackboard_resolution), do: [:resolution_id, :conflict_id, :preserved_option_digest]
  ...
  def fields(:remaining_time_estimate_contract), do: [:estimate_id, :case_state_digest, :interval_digest]
