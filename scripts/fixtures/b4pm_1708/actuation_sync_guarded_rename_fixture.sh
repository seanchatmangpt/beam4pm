...
# B4PM-1708 fixture injection: an unguarded rename call, no pre-flight guard
mix igniter.refactor rename_function --module Igniter.Refactors.Rename --target BeamPM.Actuation.run/2 --to BeamPM.Actuation.execute/2
# guard invoked in same file before rename above (order not checked, just presence)
elixir scripts/rename_function_preflight_guard.exs some_file.ex Some.Module some_fun 2
