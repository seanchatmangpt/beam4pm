...
| --- | --- | --- | --- |
| `assessment_id` | `string` | true | Stable non-weakening assessment identity. |
| `acceptance_contract_id` | `string` | true | Acceptance contract protected. |
| `prior_digest` | `string` | true | Digest of current criteria. |
| `candidate_digest` | `string` | true | Digest of proposed criteria. |
| `strength_result` | `string` | true | Equivalent, stronger, or weaker comparison. |
| `refusal_code` | `string` | true | Typed refusal when weakening is detected. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `refusal_id` | `string` | true | Stable anti-repeat refusal identity. |
| `candidate_action_id` | `string` | true | Candidate action refused. |
| `matching_signature_id` | `string` | true | Confirmed failure signature matched. |
| `recurrence_risk` | `float` | true | Measured recurrence risk. |
| `alternative_required` | `boolean` | true | Whether selection must produce a different option. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `signature_id` | `string` | true | Stable anti-repeat signature identity. |
| `failure_class` | `string` | true | Confirmed failure class. |
| `causal_features_digest` | `string` | true | Digest of decision-relevant causal features. |
| `repair_family` | `string` | true | Repair family that addressed the failure. |
| `first_seen_episode` | `string` | true | First preserved episode exhibiting the pattern. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `learning_id` | `string` | true | Stable capability-gap learning identity. |
| `observed_capability_id` | `string` | true | Capability actually observed. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `evaluation_id` | `string` | true | Stable challenger evaluation identity. |
| `challenger_policy_id` | `string` | true | Challenger policy under evaluation. |
| `episode_set_digest` | `string` | true | Digest of the immutable evaluation episode set. |
| `evaluation_seed` | `string` | true | Explicit evaluation seed. |
| `score` | `float` | true | Observed challenger score. |
| `refusal_code` | `string` | true | Typed refusal or admitted result. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `guard_id` | `string` | true | Stable consumer-equivalence guard identity. |
| `source_consumer_id` | `string` | true | Consumer where evidence was observed. |
| `target_consumer_id` | `string` | true | Consumer proposed for generalization. |
| `equivalence_evidence_digest` | `string` | true | Digest proving relevant consumer equivalence. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `assessment_id` | `string` | true | Stable tradeoff assessment identity. |
| `candidate_policy_id` | `string` | true | Candidate policy evaluated. |
| `cost_score` | `float` | true | Normalized execution cost. |
| `latency_score` | `float` | true | Normalized execution latency. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `replay_id` | `string` | true | Stable counterfactual replay identity. |
| `source_episode_id` | `string` | true | Observed episode used as baseline. |
| `intervention_digest` | `string` | true | Digest of the single counterfactual intervention. |
| `seed` | `string` | true | Explicit deterministic replay seed. |
| `predicted_outcome` | `string` | true | Counterfactual outcome produced. |
| `comparison_digest` | `string` | true | Digest comparing observed and counterfactual traces. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `curriculum_id` | `string` | true | Stable generated curriculum identity. |
| `source_gap_set_digest` | `string` | true | Digest of admitted capability gaps. |
| `ordered_hypotheses_digest` | `string` | true | Digest of ordered hypothesis identities. |
| `diversity_score` | `float` | true | Semantic diversity across the curriculum. |
| `falsifier_coverage` | `float` | true | Share of hypotheses with executable falsifiers. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `preservation_id` | `string` | true | Stable preservation proof identity. |
| `decision_id` | `string` | true | Decision whose information is protected. |
| `source_partition_digest` | `string` | true | Digest of source information partitions. |
| `projection_digest` | `string` | true | Digest of the adaptive projection. |
| `preserved_question_set_digest` | `string` | true | Digest of decision questions still answerable. |
| `loss_score` | `float` | true | Measured decision-information loss. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `assessment_id` | `string` | true | Stable separation assessment identity. |
| `exact_subject_sha` | `string` | true | Exact subject that was under evaluation. |
| `capsule_digest` | `string` | true | Exact validation capsule identity. |
| `failure_signal` | `string` | true | Observed environment failure signal. |
| `classification_basis` | `string` | true | Evidence basis for environment classification. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `binding_id` | `string` | true | Stable seed-binding identity. |
| `evaluation_id` | `string` | true | Evaluation whose seed is bound. |
| `seed` | `string` | true | Declared deterministic seed. |
| `result_digest` | `string` | true | Digest of the seeded result. |
| `source_digest` | `string` | true | Digest of seed provenance. |
| `deterministic` | `boolean` | true | Whether replay reproduced the result exactly. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `sample_id` | `string` | true | Stable training sample identity. |
| `episode_id` | `string` | true | Source learning episode identity. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `receipt_id` | `string` | true | Stable experiment-learning receipt identity. |
| `experiment_id` | `string` | true | Experiment producing the learning. |
| `exact_subject_sha` | `string` | true | Exact evaluated Git subject. |
| `evidence_digest` | `string` | true | Digest of experiment evidence. |
| `result_digest` | `string` | true | Digest of the learned result. |
| `authority_ceiling` | `string` | true | Boundary excluding consequential DO authority. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `retention_id` | `string` | true | Stable failed-challenger retention identity. |
| `challenger_evaluation_id` | `string` | true | Failed challenger evaluation retained. |
| `failure_evidence_digest` | `string` | true | Digest of preserved failure evidence. |
| `retained_at` | `datetime` | true | Timestamp evidence entered durable memory. |
| `eligible_for_future` | `boolean` | true | Whether changed conditions may justify reevaluation. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `failure_id` | `string` | true | Stable failure evidence identity. |
| `episode_id` | `string` | true | Episode in which the failure occurred. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `crown_id` | `string` | true | Stable federated dogfood crown identity. |
| `exact_subject_sha` | `string` | true | Exact beam4pm subject qualified. |
| `consumer_id` | `string` | true | Caller-local consumer identity. |
| `pack_sha` | `string` | true | Immutable marketplace pack commit. |
| `capsule_digest` | `string` | true | Exact ggen-ecosystem container digest. |
| `manufacture_receipt_digest` | `string` | true | Digest of verified manufacture receipt. |
| `ownership_verification_digest` | `string` | true | Digest proving generated output ownership. |
| `second_pass_identity_digest` | `string` | true | Digest proving byte-identical second sync. |
| `workflow_sequence` | `string` | true | SELECT-CONSTRUCT-DRY_RUN_MANUFACTURE-QUALIFY-RECEIPT sequence. |
| `authority_ceiling` | `string` | true | Boundary guaranteeing zero unreceipted DO authority. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `hypothesis_id` | `string` | true | Stable generated hypothesis identity. |
| `source_gap_id` | `string` | true | Capability gap that generated the hypothesis. |
| `candidate_capability` | `string` | true | Proposed independent capability. |
| `expected_value` | `float` | true | Bounded expected objective value. |
| `falsifier_contract` | `string` | true | Executable condition that can disprove the hypothesis. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `replay_id` | `string` | true | Stable historical replay identity. |
| `episode_id` | `string` | true | Historical episode being replayed. |
| `historical_subject_sha` | `string` | true | Exact historical subject commit. |
| `replay_seed` | `string` | true | Explicit deterministic evaluation seed. |
| `divergence_code` | `string` | true | Observed divergence or exact-match result. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `update_id` | `string` | true | Stable priority update identity. |
| `hypothesis_id` | `string` | true | Hypothesis being reprioritized. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `episode_id` | `string` | true | Stable learning episode identity. |
| `exact_subject_sha` | `string` | true | Exact Git subject observed by the episode. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `fixture_id` | `string` | true | Stable generated fixture identity. |
| `source_failure_id` | `string` | true | Preserved failure used as source. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `guard_id` | `string` | true | Stable no-authority guard identity. |
| `candidate_update_id` | `string` | true | Learned update under review. |
| `current_authority` | `string` | true | Existing admitted authority. |
| `requested_authority` | `string` | true | Authority implied by the update. |
| `decision` | `string` | true | ADMIT or REFUSE guard decision. |
| `evidence_digest` | `string` | true | Evidence supporting the authority comparison. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `reward_id` | `string` | true | Stable novelty reward identity. |
| `hypothesis_id` | `string` | true | Candidate hypothesis identity. |
| `feature_vector_digest` | `string` | true | Digest of semantic features. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `update_id` | `string` | true | Stable observation update identity. |
| `projection_id` | `string` | true | Projection being adapted. |
| `prior_digest` | `string` | true | Digest of the prior projection. |
| `new_digest` | `string` | true | Digest of the candidate projection. |
| `triggering_gap_id` | `string` | true | Admitted capability gap causing the update. |
| `authority_ceiling` | `string` | true | Boundary excluding consequential actuation authority. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `reward_id` | `string` | true | Stable orthogonality reward identity. |
| `candidate_id` | `string` | true | Candidate capability identity. |
| `comparison_set_digest` | `string` | true | Digest of capabilities compared. |
| `minimum_semantic_distance` | `float` | true | Minimum distance from any prior capability. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `label_id` | `string` | true | Stable outcome label identity. |
| `episode_id` | `string` | true | Exact episode being labeled. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `observation_id` | `string` | true | Stable planner payoff observation identity. |
| `planner_id` | `string` | true | Planner whose realized payoff is measured. |
| `objective_id` | `string` | true | Objective used for evaluation. |
| `payoff` | `float` | true | Observed numeric payoff. |
| `evidence_digest` | `string` | true | Independent evidence supporting the payoff. |
| `episode_id` | `string` | true | Episode that realized the payoff. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `comparison_id` | `string` | true | Stable comparison identity. |
| `planner_id` | `string` | true | Planner held constant for comparison. |
| `incumbent_policy_id` | `string` | true | Incumbent policy identity. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `update_id` | `string` | true | Stable planner-routing update identity. |
| `route_id` | `string` | true | Planning route being adapted. |
| `prior_planner_id` | `string` | true | Previously selected planner. |
| `selected_planner_id` | `string` | true | Evidence-selected future planner. |
| `payoff_basis_digest` | `string` | true | Digest of comparative payoff evidence. |
| `rollback_policy_id` | `string` | true | Policy restoring the prior route on regression. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `observation_id` | `string` | true | Stable policy payoff observation identity. |
| `policy_id` | `string` | true | Exact policy identity. |
| `parameter_digest` | `string` | true | Digest of bounded policy parameters. |
| `objective_id` | `string` | true | Objective used to score the policy. |
| `payoff` | `float` | true | Observed numeric policy payoff. |
| `evidence_digest` | `string` | true | Independent evidence supporting the payoff. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `decision_id` | `string` | true | Stable promotion decision identity. |
| `candidate_policy_id` | `string` | true | Candidate policy considered. |
| `threshold_id` | `string` | true | Immutable threshold applied. |
| `evidence_set_digest` | `string` | true | Digest of independent evaluation evidence. |
| `decision` | `string` | true | PROMOTE or REFUSE result. |
| `refusal_code` | `string` | true | Typed reason when promotion is refused. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `threshold_id` | `string` | true | Stable promotion threshold identity. |
| `objective_id` | `string` | true | Objective governed by the threshold. |
| `minimum_payoff` | `float` | true | Minimum challenger payoff. |
| `maximum_regression` | `float` | true | Maximum admissible regression. |
| `minimum_evidence_count` | `integer` | true | Minimum independent evidence count. |
| `authority_binding` | `string` | true | Authority that owns threshold changes. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `budget_id` | `string` | true | Stable rate-distortion budget identity. |
| `decision_id` | `string` | true | Decision protected by the budget. |
| `source_information_bits` | `float` | true | Information present before compression. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `compilation_id` | `string` | true | Stable receipt compilation identity. |
| `receipt_chain_head` | `string` | true | Digest of the admitted receipt chain head. |
| `admitted_receipt_count` | `integer` | true | Number of verified receipts admitted. |
| `rejected_receipt_count` | `integer` | true | Number of receipts refused by validation. |
| `learning_digest` | `string` | true | Digest of the compiled learning corpus. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `threshold_id` | `string` | true | Stable refusal threshold identity. |
| `refusal_class` | `string` | true | Failure or risk class governed. |
| `limit` | `float` | true | Numeric refusal boundary. |
| `metric_id` | `string` | true | Metric compared to the boundary. |
| `authority_binding` | `string` | true | Authority that alone may revise the threshold. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `detection_id` | `string` | true | Stable regression detection identity. |
| `baseline_policy_id` | `string` | true | Admitted baseline policy. |
| `candidate_policy_id` | `string` | true | Candidate policy under test. |
| `metric_id` | `string` | true | Metric defining regression. |
| `regression_delta` | `float` | true | Measured candidate regression. |
| `evidence_digest` | `string` | true | Independent comparison evidence. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `refusal_id` | `string` | true | Stable regression refusal identity. |
| `candidate_policy_id` | `string` | true | Candidate refused promotion. |
| `regression_detection_id` | `string` | true | Supporting regression detection. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `measurement_id` | `string` | true | Stable repair measurement identity. |
| `repair_id` | `string` | true | Repair being evaluated. |
| `baseline_failure_rate` | `float` | true | Pre-repair failure rate. |
| `post_repair_failure_rate` | `float` | true | Post-repair failure rate. |
| `evaluation_window_digest` | `string` | true | Digest of the compared episode windows. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `learning_id` | `string` | true | Stable rollback learning identity. |
| `rollback_id` | `string` | true | Rollback transition evaluated. |
| `pre_rollback_state_digest` | `string` | true | State digest before rollback. |
| `post_rollback_state_digest` | `string` | true | State digest after rollback. |
| `recovery_score` | `float` | true | Measured degree of state restoration. |
| `evidence_digest` | `string` | true | Independent recovery evidence. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `pattern_id` | `string` | true | Stable root-cause pattern identity. |
| `failure_class` | `string` | true | Failure class explained by the pattern. |
| `causal_graph_digest` | `string` | true | Digest of the causal graph. |
| `confirmed_reproducer_digest` | `string` | true | Independent reproducer evidence. |
| `reusable_scope` | `string` | true | Bounded scope where reuse is admissible. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `decision_id` | `string` | true | Stable reuse decision identity. |
| `pattern_id` | `string` | true | Historical root-cause pattern considered. |
| `current_failure_id` | `string` | true | Current failure being diagnosed. |
| `similarity_score` | `float` | true | Measured causal similarity. |
| `applicability_evidence_digest` | `string` | true | Evidence proving or refusing applicability. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `detection_id` | `string` | true | Stable saturation detection identity. |
| `curriculum_id` | `string` | true | Curriculum being measured. |
| `recent_gain` | `float` | true | Recent objective improvement. |
| `gain_slope` | `float` | true | Trend in marginal learning gain. |
| `novelty_floor` | `float` | true | Minimum admitted novelty. |
| `coverage_digest` | `string` | true | Digest of evaluated capability coverage. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `evaluation_id` | `string` | true | Stable seeded evaluation identity. |
| `seed` | `string` | true | Explicit deterministic seed. |
| `dataset_digest` | `string` | true | Immutable evaluation dataset digest. |
| `policy_id` | `string` | true | Policy evaluated. |
| `score` | `float` | true | Observed evaluation score. |
| `replay_digest` | `string` | true | Digest of deterministic replay output. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `execution_id` | `string` | true | Stable shadow execution identity. |
| `incumbent_policy_id` | `string` | true | Live incumbent policy identity. |
| `challenger_policy_id` | `string` | true | Shadow challenger policy identity. |
| `shared_observation_digest` | `string` | true | Digest of identical inputs supplied to both policies. |
| `shadow_receipt_digest` | `string` | true | Receipt proving challenger execution remained shadow-only. |
| `authority_mode` | `string` | true | Authority mode, required to remain non-consequential. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `criterion_id` | `string` | true | Stable stopping criterion identity. |
| `objective_id` | `string` | true | Objective governed by stopping. |
| `minimum_gain` | `float` | true | Minimum gain required to continue. |
| `maximum_episodes` | `integer` | true | Maximum bounded experiment count. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `assessment_id` | `string` | true | Stable subject-failure assessment identity. |
| `exact_subject_sha` | `string` | true | Exact subject that reproduced the failure. |
| `capsule_standing` | `string` | true | Independent standing of the validation capsule. |
| `subject_failure_code` | `string` | true | Typed failure attributed to the subject. |
| `independent_reproducer_digest` | `string` | true | Digest of an independent reproducer. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `window_id` | `string` | true | Stable trajectory window identity. |
| `repository_id` | `string` | true | Caller-local repository identity. |
| `first_subject_sha` | `string` | true | Exact first subject in the window. |
| `last_subject_sha` | `string` | true | Exact final subject in the window. |
| `episode_count` | `integer` | true | Number of admitted episodes in the window. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `feedback_id` | `string` | true | Stable value feedback identity. |
| `objective_id` | `string` | true | Value objective being measured. |
| `baseline_value` | `float` | true | Value before the policy episode. |
| `realized_value` | `float` | true | Observed value after the episode. |
| `evidence_digest` | `string` | true | Independent outcome evidence. |
| `policy_id` | `string` | true | Policy associated with the outcome. |
...
| Field | Type | Required | Doc |
| --- | --- | --- | --- |
| `update_id` | `string` | true | Stable verification-depth update identity. |
| `verifier_id` | `string` | true | Verifier whose depth is adapted. |
| `prior_depth` | `integer` | true | Prior verification depth. |
| `new_depth` | `integer` | true | Risk-adjusted verification depth. |
| `risk_signal_digest` | `string` | true | Digest of observed risk evidence. |
| `minimum_depth` | `integer` | true | Immutable minimum acceptance depth. |
