...
- Admitted unmarked files: **40**
- Counted as manufacturing debt: **33**
...
### `hand_authored_qualification` (31 file(s), counts as debt: true)
...
### `native_engine_facade` (2 file(s), counts as debt: true)
