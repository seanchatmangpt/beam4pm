...
- Authorizing principal: Sean Chatman (repo owner) via Claude Code session_01UiCeLuzgcK2BLocBKxXw39
- Reason: Typed Gleam @external facade delegating to Elixir.BeamPM.Ferroplan; engine surface, not a bpm:RecordType projection.
...
- Authorizing principal: Sean Chatman (repo owner) via Claude Code session_01UiCeLuzgcK2BLocBKxXw39
- Reason: Elixir host wrapper (BeamPM.Ferroplan) loading the ONE ferroplan wasm32-wasip1 planner engine via wasmex; engine surface, not a bpm:RecordType projection.
...
- Authorizing principal: Sean Chatman (repo owner) via Claude Code session_01UiCeLuzgcK2BLocBKxXw39
- Reason: Delegation-only Erlang facade over the ONE ferroplan PDDL-planner wasm32-wasip1 engine (native/ferroplan submodule) hosted by Elixir/wasmex; engine surface, not a bpm:RecordType projection.
