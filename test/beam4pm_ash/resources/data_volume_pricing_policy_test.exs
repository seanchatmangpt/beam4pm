...
defmodule BeamPM.Ash.Resources.DataVolumePricingPolicyTest do
  use ExUnit.Case, async: false

  test "data_volume_pricing_policy: real Ash ETS create/read round-trips every field" do
    params =
      %{
    ...
    [read_back] = Ash.read!(BeamPM.Ash.Resources.DataVolumePricingPolicy)
    assert read_back.id == created.id
    assert read_back.data_volume_pricing_policy_id == "sample_data_volume_pricing_policy_id"
    assert read_back.account_id == "sample_account_id"
    assert read_back.unit_gb_price == 3.5
