...
defmodule BeamPM.Ash.Resources.ProrationPolicyTest do
  use ExUnit.Case, async: false

  test "proration_policy: real Ash ETS create/read round-trips every field" do
    params =
      %{
    ...
    [read_back] = Ash.read!(BeamPM.Ash.Resources.ProrationPolicy)
    assert read_back.id == created.id
    assert read_back.proration_policy_id == "sample_proration_policy_id"
    assert read_back.account_id == "sample_account_id"
    assert read_back.proration_method == "sample_proration_method"
