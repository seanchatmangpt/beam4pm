...
defmodule BeamPM.Ash.Resources.EditionUpgradePathTest do
  use ExUnit.Case, async: false

  test "edition_upgrade_path: real Ash ETS create/read round-trips every field" do
    params =
      %{
    ...
    [read_back] = Ash.read!(BeamPM.Ash.Resources.EditionUpgradePath)
    assert read_back.id == created.id
    assert read_back.edition_upgrade_path_id == "sample_edition_upgrade_path_id"
