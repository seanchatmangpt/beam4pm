...
defmodule BeamPM.Ash.Resources.SeatPricingPolicyTest do
  use ExUnit.Case, async: false

  test "seat_pricing_policy: real Ash ETS create/read round-trips every field" do
    params =
      %{
    ...
    [read_back] = Ash.read!(BeamPM.Ash.Resources.SeatPricingPolicy)
    assert read_back.id == created.id
    assert read_back.seat_pricing_policy_id == "sample_seat_pricing_policy_id"
    assert read_back.account_id == "sample_account_id"
    assert read_back.seat_price == 3.5
