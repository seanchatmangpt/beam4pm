...
defmodule BeamPM.Ash.Resources.TermSubscriptionTest do
  ...
  test "term_subscription: real Ash ETS create/read round-trips every field" do
    ...
    {:ok, starts_at_wire, 0} = DateTime.from_iso8601("2026-08-29T12:00:00.123456Z")
    assert DateTime.compare(read_back.starts_at, starts_at_wire) == :eq
    {:ok, ends_at_wire, 0} = DateTime.from_iso8601("2026-08-29T12:00:00.123456Z")
    assert DateTime.compare(read_back.ends_at, ends_at_wire) == :eq
  end
end
