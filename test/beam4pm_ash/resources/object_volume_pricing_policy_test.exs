...
defmodule BeamPM.Ash.Resources.ObjectVolumePricingPolicyTest do
  use ExUnit.Case, async: false

  test "object_volume_pricing_policy: real Ash ETS create/read round-trips every field" do
    params =
      %{
    ...
    [read_back] = Ash.read!(BeamPM.Ash.Resources.ObjectVolumePricingPolicy)
    assert read_back.id == created.id
    assert read_back.object_volume_pricing_policy_id == "sample_object_volume_pricing_policy_id"
    assert read_back.account_id == "sample_account_id"
    assert read_back.unit_object_price == 3.5
