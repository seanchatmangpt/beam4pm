...
defmodule BeamPM.Ash.Resources.RemediationSlaEvidenceTest do
  ...
  test "remediation_sla_evidence: real Ash ETS create/read round-trips every field" do
    ...
    {:ok, remediation_due_at_wire, 0} = DateTime.from_iso8601("2026-08-29T12:00:00.123456Z")
    assert DateTime.compare(read_back.remediation_due_at, remediation_due_at_wire) == :eq
