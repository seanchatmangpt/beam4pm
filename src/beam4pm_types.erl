Warning: truncated output (original token count: 109342)
Total output lines: 10019
...
-spec new_latency_budget_observation(map()) -> {ok, latency_bu…9342 tokens truncated…ct{
        opportunity_id = maps:get(opportunity_id, Map, undefined),
