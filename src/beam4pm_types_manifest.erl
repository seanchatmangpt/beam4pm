...
record_names() -> [account_master_match, account_parent_scope, alignment_move, beneficial_owner_evidence, billing_reconciliation, budget_period_alignment, case_stats, change_order_authority, committed_spend_admission, conformance_result, contracting_entity_identity, credit_risk_admission, data_migration_scope_admission, data_processing_addendum_state, dfg_edge, entitlement_event, entitlement_state, event_log, event_type, funding_approval_chain, heuristic_arc, implementation_fee_admission, indemnity_scope_admission, insurance_requirement, integration_scope_admission, invoice_entity_identity, k8s_object_ref, liability_cap_admission, log_trace, master_service_agreement_state, minimum_term_admission, object_attribute_change, object_type, oc_declare_constraint, ocel_attribute, ocel_event, ocel_object, ocel_relationship, opportunity_currency_contract, opportunity_value_range, path_schema, path_schema_query, payment_terms_admission, petri_arc, petri_place, petri_transition, planning_action, planning_state, policy_decision, pricing_basis_contract, process_variant, procurement_channel_selection, proof_of_value_budget, purchase_order_requirement, purchasing_entity_identity, queue_snapshot, renewal_term_admission, resource_allocation, revenue_schedule_assumption, sanctions_screening_result, security_addendum_state, service_credit_admission, service_span, sla_offer_admission, sojourn_time, support_tier_admission, sync_time, tax_jurisdiction_evidence, termination_right_admission, training_scope_admission, type_edge, usage_event, vendor_registration_state, volume_tier_admission].
