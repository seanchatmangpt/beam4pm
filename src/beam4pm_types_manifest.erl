...
record_names() -> [account_discovery, account_master_match, account_parent_scope, action_pin_evidence, activation_event, add_on_bundle, adoption_milestone, alignment_move, annual_subscription, approval_separation_evidence, architecture_readiness, architecture_review_evidence, artifact_digest_evidence, attestation_verification_evidence, audit_chain_evidence, availability_slo_evidence, backup_restore_evidence, baseline_metric, beneficial_owner_evidence, billing_account, billing_reconciliation, booking_readiness, budget_period_alignment, business_continuity_evidence, buying_committee, canary_decision, canary_evidence, capability_bundle, capability_gap, case_stats, catalog_release, change_control_evidence, change_order_authority, channel_agreement, chargeback_rule, commercial_approval, commercial_artifact_crown_evidence, commercial_exception, commercial_execution_receipt, commercial_forecast, commercial_outcome, commercial_quote, commercial_quote_line, commercial_value_realization, committed_spend, committed_spend_admission, compatibility_contract, configuration_export, configuration_import, conformance_result, consumption_pool, consumption_subscription, contracting_entity_identity, credit_risk_admission, cross_sell_fit, customer_health, customer_managed_key_evidence, data_egress_evidence, data_migration_scope_admission, data_processing_addendum_state, data_readiness, data_residency_policy, deal_desk_packet, deletion_proof_evidence, demo_run, demo_scenario, dependency_inventory_evidence, deployment_entitlement, developer_readiness, dfg_edge, disaster_recovery_evidence, discount_schedule, discovery_hypothesis, edition_definition, enterprise_order, enterprise_order_line, entitlement_event, entitlement_evidence, entitlement_grant, entitlement_revocation, entitlement_state, environment_profile, event_log, event_type, evidence_freshness_evidence, exception_authority, executive_business_review, executive_sponsor, expansion_opportunity, expansion_option, expansion_receipt, expansion_signal, funding_approval_chain, heuristic_arc, implementation_fee_admission, incident_response_evidence, indemnity_scope_admission, insurance_requirement, integration_readiness, integration_scope_admission, invoice_entity_identity, invoice_schedule, k8s_object_ref, leakage_finding, least_authority_evidence, legal_blocker, liability_cap_admission, license_evidence, log_trace, master_service_agreement_state, migration_contract, migration_readiness, minimum_term_admission, multiarch_evidence, mutable_identity_refusal_evidence, object_attribute_change, object_type, objection, objection_resolution, oc_declare_constraint, ocel_attribute, ocel_event, ocel_object, ocel_relationship, oci_manifest_evidence, offline_bundle_evidence, operator_readiness, opportunity_currency_contract, opportunity_value_range, order_form_admission, overage_policy, path_schema, path_schema_query, payment_terms, payment_terms_admission, performance_slo_evidence, petri_arc, petri_place, petri_transition, planning_action, planning_state, poc_exit_criteria, poc_risk, poc_scope, poc_timeline, policy_decision, pricing_basis_contract, privacy_classification_evidence, private_offer, private_registry_evidence, process_variant, procurement_acceptance_evidence, procurement_blocker, procurement_channel_selection, procurement_readiness, production_readiness, proof_of_value_budget, proof_of_value_exit_gate, provenance_binding_evidence, purchase_order_binding, purchase_order_requirement, purchasing_entity_identity, queue_snapshot, quota_policy, ramp_commitment, receipt_replay_evidence, recovery_plan, remediation_sla_evidence, renewal_evidence, renewal_health, renewal_option, renewal_risk, renewal_term_admission, reproducible_build_evidence, reseller_authorization, residency_evidence, resource_allocation, retention_policy_evidence, revenue_attribution, revenue_contract_admission, revenue_schedule_assumption, rework_cost, rfp_response_evidence, rollback_decision, rollback_evidence, sanctions_screening_result, sbom_inventory_evidence, secret_boundary_evidence, security_addendum_state, security_blocker, security_readiness, service_credit, service_credit_admission, service_level_objective, service_span, showback_allocation, signature_evidence, sku_definition, sla_offer_admission, sojourn_time, solution_fit, stakeholder_map, stale_subject_refusal_evidence, success_plan, support_contract, support_escalation_evidence, support_readiness, support_sla_evidence, support_tier_admission, support_window_evidence, sync_time, target_metric, tax_jurisdiction_evidence, technical_blocker, tenant_account, tenant_project, term_subscription, termination_right_admission, time_to_value, training_readiness, training_scope_admission, true_up_policy, type_edge, unsupported_capability_evidence, upgrade_evidence, upsell_readiness, usage_event, usage_plan, usage_signal, value_baseline, value_driver, value_realization, value_receipt, vendor_registration_state, vendor_risk_evidence, version_lifecycle_evidence, volume_tier_admission, vulnerability_scan_evidence].
